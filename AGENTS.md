...
Phase 2 is now authorized: a full-site rough draft with Point of View, How I Work, Selected Work, IMAGE, About, Contact, a dedicated Work index, reusable project pages for Monti Institute, Sassy Alchemy, and Dinner / Editorial Photography, and a separate Talent page. Preserve the approved hero, camera, typography, spacing, and motion; only navigation/section connections may change. Use the RA—001 through RA—006 editorial indexing system after the hero. Later sections should diverge from Sahor and draw on the supplied art-director references without copying them. Keep missing media and unconfirmed details visibly labeled; never invent clients, outcomes, metrics, seniority, social accounts, or photographs of Reese. The only supplied acting credit is Lake Money, Camille, Independent Film, 2026. All work remains local and uncommitted.
